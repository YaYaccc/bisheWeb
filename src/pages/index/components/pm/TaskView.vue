...
<template>
    <div>
        ...
        >
            <div v-if="showTopBar && editInfo.project" class="task-nav-box">
                <Row>
                    <Col span="12">
                        <template
                            v-if="taskList != null && taskList.length > 1"
                        >
                            <span
                            ...
                            <span
                                ...
                                :class="{
                                    'switch-task-btn-disabled':
                                        currentTaskIndex == taskList.length - 1
                                }"
                                >{{ $t("下一个") }}</span
                            >
                        </template>
                    ...
                    <Col span="12" style="text-align:right">
                        <span
                            ...
                            class="text-no-wrap goto-task-list-btn"
                            >{{
                                $t("前往列表", [
            ...
            <Row class="header">
                <Col span="12" class="header-left">
                    ...
                    >
                        {{ task.objectTypeName }} #{{ task.serialNo }}
                    </div>
                    <OverdueLabel
                ...
                <Col span="12">
                    <div
                        style="display:flex;align-items:center;height:34px;text-align:right;justify-content: flex-end"
                    >
                        <IconButton
                        ...
                        <Poptip
                            trigger="click"
                            v-model="headerAttachmentVisiable"
                            v-if="
                                tperm(['task_add_attachment', 'task_edit']) &&
                                    !projectFinishDisabled
                            "
                        ...
                        >
                            ...
                            <div slot="content">
                                <TaskSelectAttachmentView
                                    ...
                                    @on-select="selectAttachmentFile"
                                ></TaskSelectAttachmentView>
                            </div>
                        </Poptip>
                        <IconButton
                        ...
                        <IconButton
                            v-if="
                                tperm('task_delete') && !projectFinishDisabled
                            "
            ...
            <div class="task-box">
                <div ref="viewBox" class="main-content-box scrollbox">
                    <Row class="project-box">
                        <Alert v-if="task.isFreeze" type="warning"
                            >{{
                                task.objectTypeName
                            }}进入变更流程被冻结，暂无法编辑</Alert
                        >
                        <Col span="12">
                        ...
                        <Col span="12" style="text-align:right">
                            ...
                            />
                            <span
                                style="padding-left:10px;display: inline-block;vertical-align: middle;"
                                >{{ task.createTime | fmtDeltaTime }}
                                {{ $t("创建") }}</span
                            >
                        </Col>
                    </Row>
                        ...
                        <Row style="margin-top:10px">
                            <Col span="12" style="min-height:24px">
                                <MemberSelect
                                    ...
                                    :disabled="
                                        memberDisable || isProjectSetTask
                                    "
                                ...
                                >
                                    <template v-if="item.isSystemField">
                                        ...
                                        <TaskObjectSelect
                                            :disabled="propDisable"
                                            v-if="
                                                item.field == 'repositoryName'
                                            "
                                            @change="updateTask('repositoryId')"
                                            :object-list="
                                                editInfo.repositoryList
                                            "
                                        ...
                                        >
                                            ...
                                            <IconButton
                                                @click="
                                                    showWorkTimeBox = !showWorkTimeBox
                                                "
                                                :title="$t('查看记录')"
                                            ></IconButton>
                                            <span
                                                v-if="
                                                    task.workTimeLogList &&
                                                        task.workTimeLogList
                                                            .length > 0
                                                "
                                                >（
                                        ...
                                        <div
                                            v-if="item.field == 'expectEndDate'"
                                        >
                                            <DateSelect
                                                :disabled="propDisable"
                                                :options="endDateOptions"
                                                @change="
                                                    updateTask('expectEndDate')
                                                "
                                                type="date"
                    ...
                    <div class="section-box">
                        <template v-if="showWorkTimeBox">
                            <div class="info-section-row">
                                ...
                                <span class="info-section-header-sub">
                                    {{ task.workTimeLogList.length }}
                                </span>
                            </div>
                            <table
                            ...
                            >
                                <tbody>
                                    ...
                                    >
                                        <td
                                            style="width:130px;font-weight:bold;font-size:14px"
                                        >
                                        ...
                                        <td>
                                            <div
                                                style="max-width:310px;word-wrap: break-word;"
                                            >
                                                {{ item.content }}
                                            </div>
                                        </td>
                        ...
                        <div class="info-section-row">
                            <div
                                style="position: absolute;top:49.5%;right:3.3%;"
                            >
                                <IconButton
                                    :size="20"
                                    style=""
                                    @click="showTypeControl"
                                    icon=""
                                    :title="$t('存储信息')"
                                >
                                </IconButton>
                        ...
                        >
                            <RichtextLabel
                                :value="task.content"
                                :placeholder="$t('未设置详细描述')"
                            ></RichtextLabel>
                        </div>

                        <div
                            class="description-box"
                            v-show="descEdit == true && !projectFinishDisabled"
                        >
                            <RichtextEditor
                                ref="descEditor"
                                v-model="task.content"
                                @on-change="changeDesc"
                            ></RichtextEditor>
                            <div style="margin-top:10px;text-align:right">
                                <Button
                                    type="text"
                                    style="margin-right:10px"
                                    @click="descEdit = false"
                                    >{{ $t("取消") }}
                                </Button>
                                <Button
                                    type="default"
                        ...
                        <template
                            v-if="
                                task.attachmentList.length > 0 ||
                                    (task.wikiPageList &&
                                        task.wikiPageList.length > 0)
                            "
                        >
                            <div class="info-section-row">
                                <div class="info-section-header">
                                ...
                                <span class="info-section-header-sub"
                                    >{{
                                        task.attachmentList.length +
                                            (task.wikiPageList
                                                ? task.wikiPageList.length
                                                : 0)
                                    }}
                                </span>
                                ...
                                <div class="info-section-opt">
                                    <Poptip
                                        trigger="click"
                                        v-model="contentAttachmentVisiable"
                                        v-if="
                                            tperm('task_add_attachment') &&
                                                tperm('task_edit') &&
                                                !projectFinishDisabled
                                        "
                                        placement="right"
                        ...
                        <template v-if="task.objectType == 4">
                            <div class="info-section-row">
                                ...
                                <span class="info-section-header-sub">{{
                                    task.testCaseList.length
                                }}</span>
                                <div class="info-section-opt">
                                    <IconButton
                                        v-if="!projectFinishDisabled"
                            ...
                            >
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td
                                            style="text-align:right;width:200px;color:#999"
                                        >
                            ...
                            <div
                                class="table-nodata"
                                v-if="task.testCaseList.length == 0"
                            >
                                {{ $t("暂无用例") }}
                            </div>
                        </template>
                        ...
                        <template
                            v-if="
                                task.associatedList.length +
                                    task.subTaskList.length +
                                    task.parentTaskList.length >
                                    0
                            "
                        >
                            <div class="info-section-row">
                        ...
                        >
                            ...
                            <span
                                ...
                                :class="{
                                    'info-section-header-deactive':
                                        showLogView !== 'changeLog'
                                }"
                            >
                                {{ $t("变更记录") }}
                                <span
                                    class="list-count"
                                    v-if="changeLogList.length > 0"
                                    >{{ changeLogList.length }}</span
                                >
                                <Poptip width="300">
                            ...
                            <template
                                v-if="
                                    task.statusChangeLogList &&
                                        task.statusChangeLogList.length > 0
                                "
                            >
                                <span style="padding-left:5px;padding-right:5px"
                                    >/</span
                                ...
                                <span
                                    ...
                                    :class="{
                                        'info-section-header-deactive':
                                            showLogView !== 'statusFlow'
                                    }"
                                    >{{ $t("流转图") }}</span
                                >
                            </template>
                            <template
                                v-if="task.isFreeze || task.alterationId > 0"
                            >
                                <span style="padding-left:5px;padding-right:5px"
                                    >/</span
                                >
                                <span
                                    ...
                                    :class="{
                                        'info-section-header-deactive':
                                            showLogView !== 'alterationLog'
                                    }"
                                >
                                    {{ $t("变更申请") }}
                                    <span class="list-count">{{
                                        alterationList.length
                                    }}</span>
                                </span>
                            </template>
                            <template v-if="testCaseRunLogCount > 0">
                                ...
                                <span
                                    ...
                                    :class="{
                                        'info-section-header-deactive':
                                            showLogView !== 'testCaseRunLog'
                                    }"
                                >
                                    {{ $t("执行记录") }}
                                    <span
                                        class="list-count"
                                        v-if="testCaseRunLogCount > 0"
                                        >{{ testCaseRunLogCount }}</span
                                    >
                                </span>
                            </template>
                        </div>
                            ...
                            >
                                <tbody>
                                    ...
                                    >
                                        ...
                                        <td
                                            style="text-align:right;min-width:200px;color:#999"
                                        >
                                            <span class="table-row">
                                                ...
                                                <span
                                                    v-if="item.status == 3"
                                                    style="font-weight: 500;color:darkgrey"
                                                    >已取消</span
                                                >
                                                <AvatarImage
                                                    style="margin: 0 10px;"
                        ...
                        >
                            <div
                                class="table-nodata"
                                v-if="testCaseRunLogList.length === 0"
                            >
                                {{ $t("暂无数据") }}
                            </div>
                            <table
                            ...
                            >
                                ...
                                <tbody>
                                    <template
                                        v-for="item in testCaseRunLogList"
                                    >
                                        <tr :key="item.id">
                ...
                <div
                    class="footer-box"
                    :class="{ 'footer-box-open': commitBoxOpen }"
                >
                    <Row v-if="!projectFinishDisabled">
                        <Col
                            span="2"
                            :style="{
                                paddingTop: commitBoxOpen ? '20px' : '0px'
                            }"
                        >
                            <AvatarImage
                                :name="account.name"
                        ...
                        <Col span="22">
                            ...
                            >
                                ...
                                <div style="margin-top:10px;text-align:right">
                                    <span
                                        style="color:#999;padding-right:10px"
                                        >{{ $t("输入@提醒项目成员") }}</span
                                    >
                                    <Button
                                        style="margin-right:10px"
        ...
        <div
            style="width: 550px;margin: 0 auto; height: 60%;position: fixed;top: 20%;right: 40%;background: #FFFFFF;border: 2px #CDCDCD solid"
            class="typeControl"
            v-show="typeContror"
        >
            <div
                style="border-bottom: 1px solid #C4C4C4; padding: 2% 0 2% 0 ;background: #F7F7F7"
            >
                <div class="info-section-header">
                    {{ $t("版本控制") }}
                    <div
                        style="float: right;position: absolute;right: 3%"
                        @click="closeTypeControl()"
                    >
                        X
                    </div>
                </div>
            ...
            <div style="width: 100%;">
                <h1 style="display: inline-block;margin:2% 8% 2% 8%">
                    存档名称
                </h1>
                <h1 style="display: inline-block">创建时间</h1>
                <div v-for="item in typeData" style="height: 80%;">
                    <div
                        style="margin:2% 0% 2% 8%;display: inline-block;width: 26%"
                    >
                        <h2
                    ...
                    <div
                        style="display: inline-block;width: 40%;margin-left: 5%"
                    >
                        <button
                            @click="deleteType(item.id)"
                            style="vertical-align:1%;width: 40%;height: 35px;background: #FFFFFF;border: 2px solid #D8D8D8;border-radius: 5px"
                        >
                            删除
                        </button>
                        <button
                            @click="returnType(item.id)"
                            style="vertical-align:1%;width: 40%;height: 35px;background: #FFFFFF;border: 2px solid #D8D8D8;border-radius: 5px;margin-left: 5%"
                        >
                            回档
                        </button>
                    </div>
            ...
            <div style="width: 100%;position:absolute;bottom: 3%">
                <input
                    style="width: 60%; height: 35px;background: #F3F3F3;border: 2px solid #D8D8D8;margin: 0 5% 0 5%"
                    type="text"
                    v-model="mingzi"
                    placeholder="请输入存档名称"
                />
                <button
                    @click="submitType()"
                    style="width: 18%;height: 35px;background: #FFFFFF;border: 2px solid #D8D8D8"
                >
                    存档
                </button>
            </div>
...
export default {
    ...
    computed: {
        showAlteration() {
            ...
            return (
                !this.projectFinishDisabled &&
                !this.task.isFreeze &&
                !this.task.isDelete &&
                !this.task.isFinish &&
                this.task.ownerAccountIdList &&
                this.task.ownerAccountIdList.indexOf(app.account.id) >= 0
            );
        },
        showGoToProject() {
            if (!this.task) {
            ...
            return (
                !this.projectFinishDisabled && !!this.task.associateProjectUuid
            );
        },
        propDisable() {
        ...
        showTaskLinkBtn() {
            ...
            return (
                this.task.objectTypeSystemName !==
                process.env.VUE_APP_PROJECT_SET_OBJECT_TYPE_SYSTEM_NAME_PRO
            );
        },
        taskEditStartEndDateDisable() {
            return (
                this.propDisable ||
                !this.tperm(`task_edit_startend_date`) ||
                this.projectFinishDisabled
            );
        },
        finishTimeDisable() {
    ...
    methods: {
        loadData() {
            app.invoke(
                "BizAction.getTaskInfoByUuid",
                [app.token, this.taskUUID],
                info => {
                    this.permissionMap = {};
                    ...
                    this.projectFinishDisabled = this.isProjectDisabled(
                        info.task.projectId
                    );
                    //项目集任务
                    this.isProjectSetTask =
                        info.task.objectTypeSystemName ===
                        process.env
                            .VUE_APP_PROJECT_SET_OBJECT_TYPE_SYSTEM_NAME_PRO;
                    this.isProjectSetTaskOwner =
                        this.isProjectSetTask &&
                        !Array.isEmpty(info.task.ownerAccountIdList) &&
                        info.task.ownerAccountIdList.some(
                            item => item === app.account.id
                        );
                    if (
                        !!editTaskContent &&
                        editTaskContent !== info.task.content
                    ) {
                    ...
                    for (
                        var j = 0;
                        j < info.editTaskInfo.memberList.length;
                        j++
                    ) {
                    ...
                    for (
                        var k = 0;
                        k < info.editTaskInfo.fieldList.length;
                        k++
                    ) {
                    ...
                    if (
                        this.task.objectTypeSystemName ===
                        process.env
                            .VUE_APP_TEST_CASE_OBJECT_TYPE_SYSTEM_NAME_TCA
                    ) {
        ...
        loadTypeData() {
            app.invoke(
                "BizAction.getTaskSaveList",
                [app.token, this.changeLogQuery.taskId],
                info => {
                    info.forEach(item => {
        ...
        filterChangeLog(item) {
            ...
            if (this.filterChangeLogUserName != null) {
                ret =
                    item.createAccountName.indexOf(
                        this.filterChangeLogUserName
                    ) > -1;
            }
            return ret;
        },
        ...
        showTypeControl() {
            this.typeContror = !this.typeContror;
            this.loadTypeData();
        },
        closeTypeControl() {
            this.typeContror = !this.typeContror;
        ...
        submitType() {
            app.invoke(
                "BizAction.saveTaskInfo",
                [app.token, this.task, this.mingzi],
                info => {
                    console.log(info);
                    this.mingzi = "";
                    this.loadTypeData();
        ...
        tperm(list) {
            ...
            if (app.account.superBoss) {
                if (app.account.superBoss == 1 || app.account.superBoss == 3) {
                    ...
                    app.account.superBoss == 2 ||
                    app.account.superBoss == 4
                ) {
                    if (Array.isArray(list)) {
                        var readPermissionCount = list.filter(
                            item =>
                                item.indexOf("_list") > -1 ||
                                item.indexOf("_view") > 0 ||
                                item.indexOf("_log") > 0
                        ).length;
                        ...
                        if (
                            list.indexOf("_list") > 0 ||
                            list.indexOf("_view") > 0 ||
                            list.indexOf("_log") > 0
                        ) {
                            return true;
                        }
            ...
            if (Array.isArray(list)) {
                const index = list.findIndex(t => {
                    return (
                        this.permissionMap[t + "_" + this.task.objectType] ===
                        true
                    );
                });
                return index > -1;
            ...
            return (
                this.permissionMap[list + "_" + this.task.objectType] === true
            );
        },
        ...
        syncComment() {
            if (this.replyContent == null || this.replyContent === "") {
                ...
                app.saveObject("TaskView.comment" + this.task.id, {
        ...
        copyTaskToOldTask() {
            ...
            this.oldTask.customFields = Object.assign(
                {},
        ...
        loadComment() {
            ...
            app.invoke(
                "BizAction.getTaskCommentInfoList",
                [app.token, this.commentQuery],
                list => {
        ...
        loadTestPlanTestCaseRunLogList() {
            ...
            app.invoke(
                "BizAction.getTestPlanTestCaseRunLogList",
                [app.token, this.testCaseRunLogQuery],
                res => {
                    let list = res.list;
        ...
        updateTask0(field) {
            ...
            if (field.indexOf("field_") != -1) {
                ...
                if (!Array.isArray(newValue)) {
                    if (
                        this.oldTask.customFields[field] ==
                        this.task.customFields[field]
                    ) {
                        return;
                    }
                }
            ...
            if (field == "startDate" || field == "endDate") {
                if (this.task.subTaskCount > 0) {
                    ...
                    app.invoke(
                        "BizAction.getTaskAssociateStat",
                        [app.token, this.task.id],
                        info => {
                            if (info.beforeCount > 0 || info.afterCount > 0) {
                                app.confirm(
                                    "该对象关联有前后置对象，是否需要同步其开始截止时间?",
                                    () => {
                                        this.updateTaskNative(
                                            obj,
                                            [field],
                                            false
                                        );
        ...
        updateTaskNative(obj, field, isManualUpdate) {
            app.invoke(
                "BizAction.updateTask",
                [app.token, obj, field, isManualUpdate],
                info => {
                    if (field == "status") {
        ...
        uploadSuccess(uuid) {
            app.invoke(
                "BizAction.addTaskAttachment",
                [app.token, uuid.uuid, this.task.id],
                info => {
                    this.loadData();
                }
            );
        ...
        deleteAttachment(item, type) {
            app.confirm(this.$t("确定要删除附件", [item.name]), () => {
                app.invoke(
                    "BizAction.deleteTaskAttachment",
                    [app.token, this.task.id, item.id, type],
                    info => {
                        this.loadData();
                    }
                );
        ...
        showSelectTaskDialog(type) {
            ...
            if (type > 0) {
                ...
                app.showDialog(TaskSelectDialog, {
                    singleProject:
                        this.task.objectType == 4 || this.task.objectType == 5, //测试计划和测试用例只能关联本项目
                    objectType: this.task.objectType,
                    projectId: this.task.projectId,
                    startDate: startDate,
                    endDate: endDate,
                ...
                app.showDialog(TaskSelectDialog, {
                    singleProject:
                        this.task.objectType == 4 || this.task.objectType == 5,
                    projectId: this.task.projectId,
                    callback: list => {
                        this.addRelTask(type, list);
                    }
        ...
        addRelTestCase(list) {
            ...
            app.invoke(
                "BizAction.addTestPlanTestCaseList",
                [app.token, this.task.id, ids],
                info => {
                    app.postMessage("task.edit");
                    this.loadData();
                }
        ...
        addRelTask(type, list) {
            ...
            app.invoke(
                "BizAction.addTaskAssociatedList",
                [app.token, this.task.id, type, ids],
                info => {
                    app.postMessage("task.edit");
                    this.loadData();
                }
        ...
        deleteTestCase(item) {
            app.confirm(this.$t("确定要解除关联", [item.testCaseName]), () => {
                app.invoke(
                    "BizAction.deleteTestPlanTestCase",
                    [app.token, item.id],
                    info => {
                        app.postMessage("task.edit");
                        this.loadData();
        ...
        deleteRelObj(item) {
            app.confirm(this.$t("确定要解除关联", [item.name]), () => {
                app.invoke(
                    "BizAction.deleteTaskAssociated",
                    [app.token, item.id],
                    info => {
                        app.postMessage("task.edit");
                        this.loadData();
        ...
        quoteCommentReply(item) {
            ...
            this.replyContent =
                ...
                "</blockquote>";
            this.replyContent +=
                '<div><a href="javascript:;" data-mention="true">@' +
                item.createAccountName +
                "(" +
                item.createAccountUserName +
                ")" +
                "</a>&nbsp;</div>";
        },
        deleteComment(item) {
            app.confirm(
                this.$t("确定要删除评论", [item.createAccountName]),
                () => {
                    app.invoke(
                        "BizAction.deleteTaskComment",
                        [app.token, item.id],
                        info => {
                            this.loadComment();
                        }
        ...
        gotoProjectTaskList() {
            ...
            app.loadPage(
                "/pm/project/" +
                    this.editInfo.project.uuid +
                    "/task" +
                    this.task.objectType,
                args
            );
        },
        showNextTask(delta) {
        ...
        addTaskAttachment() {
            ...
            if (this.taskAttachment.type === "wiki") {
                app.invoke(
                    "BizAction.addTaskWiki",
                    [app.token, this.taskAttachment.uuid, this.task.id],
                    info => {
                        this.taskAttachment = null;
                        this.loadData();
                    }
        ...
        previewWikiPage(wikiPage) {
            app.invoke(
                "BizAction.getWikiPageById",
                [app.token, wikiPage.id],
                info => {
        ...
        loadAlterationList() {
            app.invoke(
                "TaskAlterationAction.getTaskAlterationList",
                [app.token, { taskId: this.task.id }],
                list => {
        ...
        toggleTaskStar() {
            ...
            app.invoke(
                action,
                [app.token, { type: 2, associateId: this.task.id }],
                () => {
